...
public interface AccessorOptimizer {
    /** 正常调用访问 */
    int ACCESS_REGULAR = 0;
    /** set类调用 */
    int ACCESS_SET = 1;
    /** 集合类访问 */
    int ACCESS_COLLECTION = 2;
    /** 对象创建类调用 */
    int ACCESS_OBJ_CREATION = 3;
    ...
    AccessorNode optimizeAccessor(ParserContext pCtx, char[] property, int start, int offset, Object ctx, Object thisRef,
                                  VariableResolverFactory factory, Class ingressType);

    /** 创建出相应的设置类优化访问器,对指定的属性 */
    AccessorNode optimizeSetAccessor(ParserContext pCtx, char[] property, int start, int offset, Object ctx, Object thisRef,
    ...
    AccessorNode optimizeCollection(ParserContext pCtx, Object collectionGraph, Class type, char[] property, int start, int offset, Object ctx, Object thisRef, VariableResolverFactory factory);

    /** 创建一个用于对象创建的访问器 */
    AccessorNode optimizeObjectCreation(ParserContext pCtx, char[] property, int start, int offset, Object ctx, Object thisRef, VariableResolverFactory factory);
