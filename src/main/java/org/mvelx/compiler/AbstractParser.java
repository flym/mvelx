...
import org.mvelx.ErrorDetail;
import org.mvelx.Operator;
import org.mvelx.ParserContext;
import org.mvelx.DataConversion;
import org.mvelx.ast.*;
import org.mvelx.integration.VariableResolverFactory;
import org.mvelx.util.ErrorUtil;
import org.mvelx.util.ExecutionStack;
import org.mvelx.util.FunctionParser;
...
import static org.mvelx.util.ArrayTools.findFirst;
    ...
    protected void reduce() {
        ...
        try{
            switch(operator = (Integer) stk.pop()) {
                ...
                //转换操作
                case CONVERTABLE_TO:
                    stk.push(DataConversion.canConvert(stk.peek2().getClass(), (Class) stk.pop2()));
                    break;
